                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered">
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="2"> Penduduk Lahir Bulan ini</td>
                                                <td colspan="2"> Penduduk Mati Bulan ini</td>
                                                <td colspan="2"> Penduduk Pendatang Bulan ini</td>
                                                <td colspan="2"> Penduduk Pindah Bulan ini</td>
                                            ...
                                            <tbody class="text-center">
                                                ...
                                                @foreach($mati as $row1)
                                                @foreach($pendatang as $row2)
                                                @foreach($pindah as $row3)
                                                <tr>
                                                    <td>{{ $no++}} </td>   
                                                    <td>{{ $row->L}}</td>   
                                                    <td>{{ $row->P}}</td>   
